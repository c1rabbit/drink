...
router.get('/store/:_id/info/edit',StoreController.editInfo);
router.get('/store/:_id/menu/edit',StoreController.editMenu);
router.post('/store/:_id/menu',StoreController.addMenuItem);
router.delete('/store/menu/:_id',StoreController.deleteMenuItem);
